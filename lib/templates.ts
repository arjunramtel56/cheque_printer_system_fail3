...
export const BANK_TEMPLATES: BankTemplate[] = [
  {
    ...
    fields: {
      ...
      accountPayee: { x: 0, y: 16, width: 190.5, fontSize: 9, minFontSize: 7, align: "center" },
    ...
    profiles: {
      custom_short: { x: 0, y: 0, pageWidth: 88.9, pageHeight: 190.5, rotate: 90 },
      custom_long: { x: 0, y: 0, pageWidth: 190.5, pageHeight: 88.9, rotate: 0 },
  ...
  },
  {
    ...
    fields: {
      ...
      accountPayee: { x: 0, y: 14, width: 190.5, fontSize: 9, minFontSize: 7, align: "center" },
  ...
  },
  {
    ...
    fields: {
      ...
      accountPayee: { x: 0, y: 18, width: 190.5, fontSize: 9, minFontSize: 7, align: "center" },
  ...
  },
  {
    ...
    fields: {
      ...
      accountPayee: { x: 0, y: 12, width: 190.5, fontSize: 9, minFontSize: 7, align: "center" },
  ...
  },
  {
    ...
    fields: {
      ...
      accountPayee: { x: 0, y: 20, width: 190.5, fontSize: 9, minFontSize: 7, align: "center" },
