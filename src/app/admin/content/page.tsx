  ...
  return (
    <div style={{ display: "grid", gap: 20, maxWidth: "1000px" }}>
      <div>
        ...
        <h2 style={{ margin: "0 0 4px 0", fontSize: "1.12rem", color: "var(--text-primary)" }}>Content</h2>
        <p style={{ margin: 0, fontSize: "0.83rem", color: "var(--text-muted)" }}>
          Manage marketing and help content.
        </p>
      </div>

      <div className="card" style={{ padding: 60, textAlign: "center", color: "var(--text-muted)" }}>
        <FileText size={36} style={{ opacity: 0.3, marginBottom: 12 }} />
        <p style={{ fontWeight: 600, color: "var(--text-secondary)", marginBottom: 4 }}>Content Management</p>
        <p style={{ fontSize: "0.85rem" }}>Edit marketing pages and documentation.</p>
      </div>
    </div>
  );
}
