      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "16px 30px", borderBottom: "1px solid var(--border)", background: "var(--surface)" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <h1 style={{ fontSize: "22px", fontWeight: 700, color: "var(--text-primary)" }}>Calibration</h1>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <ThemeToggle />
            <LanguageToggle />
        ...
        <main style={{ flex: 1, padding: "30px" }}>
          <div className="card" style={{ padding: 60, textAlign: "center", color: "var(--text-muted)" }}>
            ...
            <p style={{ fontWeight: 600, color: "var(--text-secondary)", marginBottom: 4 }}>Calibration</p>
            <p style={{ fontSize: "0.85rem" }}>Adjust print calibration for your cheques.</p>
          </div>
        </main>
      </div>
    </div>
